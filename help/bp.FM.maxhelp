...
,
									"patching_rect" : [ 44.0, 611.0, 245.0, 116.0 ],
									"varname" : "CombFilter",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.0, 69.0, 787.0, 65.0 ],
									"style" : "",
									"text" : "In audio and music, frequency modulation synthesis (or FM synthesis) is a form of audio synthesis where the timbre of a simple waveform (such as a square, triangle, or sawtooth) is changed by modulating its frequency with a modulator frequency that is also in the audio range, resulting in a more complex waveform and a different-sounding tone that can also be described as \"gritty\" if it is a thick and dark timbre.",
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 53.5, 742.0, 505.0, 742.0, 505.0, 610.0, 485.5, 610.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 53.5, 742.0, 334.0, 742.0, 334.0, 610.0, 356.5, 610.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 615.5, 537.0, 267.0, 537.0, 267.0, 408.0, 245.5, 408.0 ],
									"source" : [ "obj-22", 0 ]
								}
...
, 			{
				"name" : "bp.FM.maxpat",
				"bootpath" : "~/Documents/beap_working_copy/clippings/BEAP/Oscillator",
