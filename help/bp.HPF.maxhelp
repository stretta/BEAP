...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 623.0, 515.0, 181.0, 25.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 462.0, 730.0, 181.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 462.0, 463.0, 170.0, 116.0 ],
									"varname" : "bp.LFO2",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 233.0, 681.0, 181.0, 40.0 ],
									"style" : "",
									"text" : "Try sweeping the Frequency "
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 416.0, 628.0, 253.0, 116.0 ],
									"varname" : "bp.HPF",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 25.0, 515.0, 314.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 25.0, 137.0, 726.0, 232.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 25.0, 382.0, 131.0, 116.0 ],
									"presentation_rect" : [ 0.0, 0.0, 131.0, 116.0 ],
									"varname" : "bp.Harmonic",
									"viewvisibility" : 1
								}
...
,
									"patching_rect" : [ 193.0, 781.0, 111.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 25.0, 781.0, 148.0, 116.0 ],
									"varname" : "bp.Stereo",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 84.0, 564.0, 36.0 ],
									"style" : "",
									"text" : "A high-pass filter is an electronic filter that passes signals with a frequency higher than a certain cutoff frequency and attenuates signals with frequencies lower than the cutoff frequency. ",
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 34.5, 501.0, 34.5, 501.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 34.5, 399.5, 34.5, 399.5 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 34.5, 642.0, 402.0, 642.0, 402.0, 624.0, 425.5, 624.0 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 425.5, 768.0, 163.5, 768.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 425.5, 768.0, 34.5, 768.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 622.5, 615.0, 581.5, 615.0 ],
									"source" : [ "obj-8", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 471.5, 615.0, 503.5, 615.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-6::obj-2" : [ "Freq[1]", "Freq", 0 ],
			"obj-2::obj-7::obj-76" : [ "Transport", "Transport", 0 ],
			"obj-2::obj-1::obj-3" : [ "bypass", "bypass", 0 ],
			"obj-2::obj-4::obj-46" : [ "Offset", "Offset", 0 ],
			"obj-2::obj-1::obj-26" : [ "Amt", "Amt", 0 ],
