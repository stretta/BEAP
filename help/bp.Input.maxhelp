...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 22.0, 133.0, 53.0, 116.0 ],
									"varname" : "bp.Input",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 229.0, 326.0, 181.0, 25.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 68.0, 541.0, 181.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 68.0, 274.0, 170.0, 116.0 ],
									"varname" : "bp.LFO2",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 22.0, 439.0, 253.0, 116.0 ],
									"varname" : "bp.HPF",
									"viewvisibility" : 1
								}
...
,
									"patching_rect" : [ 186.0, 619.0, 111.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 21.0, 619.0, 148.0, 116.0 ],
									"varname" : "bp.Stereo",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 84.0, 175.0, 21.0 ],
									"style" : "",
									"text" : "Audio Input for Channel One",
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 31.5, 252.0, 31.5, 252.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 31.5, 606.0, 159.5, 606.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 31.5, 558.0, 30.5, 558.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 228.5, 426.0, 187.5, 426.0 ],
									"source" : [ "obj-8", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 77.5, 426.0, 109.5, 426.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-12::obj-20" : [ "mute[1]", "mute", 0 ],
			...
			"obj-2::obj-12::obj-46" : [ "Channel", "Channel", 0 ],
...
, 			{
		...
		"snapshot" : 		{
			...
			"version" : 1,
			"name" : "bp.Input.maxhelp",
			"origin" : "bp.Input.maxhelp",
			"type" : "patcher",
			"subtype" : "Undefined",
			"snapshot" : 			{
				"name" : "bp.Input.maxhelp",
