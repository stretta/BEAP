...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 376.0, 405.0, 155.0, 69.0 ],
					"presentation_rect" : [ 376.0, 408.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Try holding option and dragging on a portion of the envelope..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.0, 405.0, 127.0, 69.0 ],
					"presentation_rect" : [ 350.0, 414.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Adjusting the nodes  changes the shape of the sound."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.5, 291.0, 405.0, 108.0 ],
					"style" : "",
					"text" : "Gate input initiates the envelope and holds at the sustain node until the signal is released. \n\nTrigger inputs cause the entire envelope to be output unless interrupted by another trigger.\n\nDuration of each step is a fraction of the overall Domain.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 69.0, 498.0, 36.0 ],
					"style" : "",
					"text" : "Graphic ADSR requires a Gate or Trigger signal for the ADSR envelope to commence, each time it receives this signal it completes the cycle.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 131.0, 506.0, 116.0 ],
					"varname" : "bp.Keyboard",
					"viewvisibility" : 1
				}
...
, 							{
								"box" : 								{
									"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 107.753067, 1.0, 0, 0.605, 825.390259, 0.659574, 2, -0.695, 1000.0, 0.0, 0, -0.405 ],
...
,
					"patching_rect" : [ 296.5, 287.0, 267.0, 116.0 ],
					"varname" : "bp.ADSR",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 306.0, 413.5, 113.5, 413.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 19.5, 561.0, 148.5, 561.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 263.0, 273.0, 306.0, 273.0 ],
					"source" : [ "obj-6", 1 ]
				}
