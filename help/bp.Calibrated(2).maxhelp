...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 717.0, 295.0, 148.0, 116.0 ],
									"varname" : "bp.Stereo",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 717.0, 145.0, 53.0, 116.0 ],
									"varname" : "bp.Input",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 0,
									"maxclass" : "bpatcher",
									"name" : "bp.Calibrated.maxpat",
									"numinlets" : 1,
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 148.0, 242.0, 409.757019, 116.0 ],
									"varname" : "bp.Calibrated",
									"viewvisibility" : 1
								}
...
,
									"patching_rect" : [ 148.0, 104.5, 163.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 20.300049, 312.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "5",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 324.5, 112.0, 24.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 699.0, 604.0, 33.0 ],
									"style" : "",
									"text" : "6) Specify a MIDI input port. Select your MIDI controller. You should now be able to control your oscillator with a MIDI keyboard. The LED next to the 1v/oct output should light as you press some keys on your contorller."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 657.666687, 604.0, 33.0 ],
									"style" : "",
									"text" : "5) Click the calibrate button. You should see a step-wise rising line form as the calibration procedure is performed. If this does not happen, check your connections again."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 616.333313, 593.0, 33.0 ],
									"style" : "",
									"text" : "4) Set the monitor input. Connect an output from your oscillator to an input on your audio interface. This is so you can hear (or do something else useful with the result. The LED should light if it is receiving signal."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 548.0, 596.0, 60.0 ],
									"style" : "",
									"text" : "3) Set the CV output. Connect an output from your audio interface to the 1v/oct input of your oscillator module. This is the output that Beap will use to control the pitch of the oscillator. Both the calibration input and calibration output must be connected properly before calibration can take place. Once you've connected the output, specify which output you're using here."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 452.666656, 589.0, 87.0 ],
									"style" : "",
									"text" : "2) Set the calibration input. Connect the sine wave output from your oscillator to your audio interface. Specify which input you're using here. The LED should light up to show audio activity. If this does not happen, check your connections. Note that some audio interfaces inputs may not be numbered in a sensical way. For example, there may be eight inputs on the rear of your interface labeled 1-8, but they may be offset because there may be additional inputs on the front of the interface. In that case, input 1 may actually be input 3. Also check I/O mappings in Max's Audio Status window. "
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 424.333344, 352.0, 20.0 ],
									"style" : "",
									"text" : "1) Enable DSP. Nothing will function until you do so. "
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 17.300049, 123.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "6",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 588.300049, 186.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "4",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 645.300049, 255.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "3",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.300049, 258.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 582.300049, 338.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 29.0, 135.5, 106.0, 24.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 559.0, 263.5, 96.0, 51.0 ],
									"style" : "",
									"text" : "CV output to 1v/oct input on oscillator."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 600.0, 198.5, 96.0, 24.0 ],
									"style" : "",
									"text" : "Monitor input"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 358.0, 412.0, 53.0 ],
									"style" : "",
									"text" : "NOTE: Calibration will not work unless the sigmund~ object is installed. http://crca.ucsd.edu/~tapel/software.html\nalternatively, use the Calibrate 64-bit module",
									"textcolor" : [ 0.862745, 0.207843, 0.133333, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 594.0, 349.5, 96.0, 24.0 ],
									"style" : "",
									"text" : "Turn on DSP"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 24.0, 270.5, 116.0, 24.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Produce a calibrated 1v/oct output via a DC-coupled audio interface",
...
, 			{
		...
		"parameters" : 		{
			"obj-2::obj-2::obj-28" : [ "Bend", "Bend", 0 ],
			"obj-2::obj-6::obj-52" : [ "Level", "Level", 0 ],
			"obj-2::obj-1::obj-20" : [ "mute", "mute", 0 ],
			"obj-2::obj-6::obj-55" : [ "DSP", "DSP", 0 ],
			"obj-2::obj-4::obj-22" : [ "offest", "offset", 0 ],
			"obj-2::obj-1::obj-46" : [ "Channel", "Channel", 0 ],
			"obj-2::obj-2::obj-69" : [ "1voctled", "1voctled", 0 ],
			"obj-2::obj-4::obj-54" : [ "mute[1]", "mute", 0 ],
			"obj-2::obj-2::obj-20" : [ "ModWheelActivityLED[1]", "ModWheelActivityLED", 0 ],
			"obj-2::obj-4::obj-2" : [ "stealth_init", "stealth_init", 0 ],
