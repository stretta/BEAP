...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 585.0, 132.0, 116.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 390.0, 275.0, 234.0, 116.0 ],
									"varname" : "bp.ADSR",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 275.0, 314.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 189.0, 630.5, 93.0, 25.0 ],
									"style" : "",
									"text" : "Wavefolder"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 69.0, 414.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 19.0, 251.0, 60.0 ],
									"style" : "",
									"text" : "Wavefolder",
									"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-7::obj-1" : [ "Bypass[1]", "Bypass", 0 ],
			"obj-2::obj-6::obj-36" : [ "PW", "PW", 0 ],
			"obj-2::obj-2::obj-55" : [ "DSP", "DSP", 0 ],
			"obj-2::obj-7::obj-29" : [ "Range", "Range", 0 ],
...
, 			{
		...
		"snapshot" : 		{
			...
			"version" : 1,
			"name" : "bp.Wavefolder.maxhelp",
			"origin" : "bp.Wavefolder.maxhelp",
			"type" : "patcher",
			"subtype" : "Undefined",
			"snapshot" : 			{
				"name" : "bp.Wavefolder.maxhelp",
