...
, 			{
		...
		"snapshot" : 		{
			...
			"version" : 1,
			"name" : "bp.Trigger Monster.maxhelp",
			"origin" : "bp.Trigger Monster.maxhelp",
			"type" : "patcher",
			"subtype" : "Undefined",
			"snapshot" : 			{
				"name" : "bp.Trigger Monster.maxhelp",
