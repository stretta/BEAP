...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 252.0, 150.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.0, 197.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 189.0, 256.0, 103.0, 22.0 ],
					"style" : "",
					"text" : "transport"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 366.0, 387.6875, 240.0, 79.0 ],
									"style" : "",
									"text" : "Chage the Gain and Bias parameters and watch the Big Scope window.\n\nThis shows you the signal shaping possibilities using Gain and Bias.",
...
,
									"patching_rect" : [ 246.0, 479.0, 372.0, 214.0 ],
									"varname" : "BigScope",
									"viewvisibility" : 1
								}
...
,
									"patching_rect" : [ 25.0, 425.0, 146.0, 116.0 ],
									"varname" : "GainAndBias",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 25.0, 274.0, 314.0, 116.0 ],
...
,
									"patching_rect" : [ 25.0, 138.0, 107.0, 116.0 ],
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 34.5, 407.0, 34.5, 407.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 34.5, 256.0, 34.5, 256.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 34.5, 605.0, 186.0, 605.0, 186.0, 468.0, 255.5, 468.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-3::obj-10" : [ "Gain", "Gain", 0 ],
			"obj-2::obj-1::obj-11" : [ "PWM", "PWM", 0 ],
			"obj-2::obj-2::obj-69" : [ "Lock", "Lock", 0 ],
			"obj-2::obj-2::obj-129" : [ "Points", "Points", 0 ],
			...
			"obj-2::obj-2::obj-1" : [ "divide", "divide", 0 ],
			"obj-2::obj-18::obj-34" : [ "Pulse", "Pulse", 0 ],
			"obj-2::obj-3::obj-55" : [ "Bypass[1]", "Bypass", 0 ],
			"obj-2::obj-1::obj-46" : [ "Offset", "Offset", 0 ],
			"obj-2::obj-1::obj-129" : [ "CV2", "CV2", 0 ],
			"obj-2::obj-3::obj-40" : [ "presets", "presets", 0 ],
...
, 			{
		...
		"snapshot" : 		{
			...
			"version" : 1,
			"name" : "bp.Gain Bias.maxhelp",
			"origin" : "bp.Gain Bias.maxhelp",
			"type" : "patcher",
			"subtype" : "Undefined",
			"snapshot" : 			{
				"name" : "bp.Gain Bias.maxhelp",
