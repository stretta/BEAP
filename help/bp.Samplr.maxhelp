...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 21.0, 256.0, 0.0, 0.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 622.0, 269.5, 0.0, 0.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "2",
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 471.0, 267.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "set duration"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 549.0, 137.0, 0.0, 0.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 439.0, 134.5, 0.0, 0.0 ],
									"style" : "",
									"text" : "trigger record"
								}
...
,
									...
									"presentation_rect" : [ 360.666656, 34.0, 0.0, 0.0 ],
									"varname" : "GatePad[1]",
									"viewvisibility" : 1
								}
...
,
									"patching_rect" : [ 125.666664, 215.0, 71.0, 116.0 ],
									"varname" : "GatePad",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 241.333328, 215.0, 53.0, 116.0 ],
									"varname" : "bp.Input",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 10.0, 339.0, 366.0, 214.0 ],
									"varname" : "bp.Samplr",
									"viewvisibility" : 1
								}
...
,
					...
					"presentation_rect" : [ 50.0, 70.0, 0.0, 0.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 10.0, 116.0, 506.0, 116.0 ],
									"varname" : "bp.Keyboard",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 10.0, 268.0, 366.0, 214.0 ],
									"varname" : "bp.Samplr",
									"viewvisibility" : 1
								}
...
,
		...
		"parameters" : 		{
			...
			"obj-1::obj-1::obj-69::obj-2" : [ "pastebang[3]", "pastebang", 0 ],
