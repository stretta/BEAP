...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 499.0, 180.0, 40.0 ],
					"presentation_rect" : [ 39.0, 499.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Try adjusting the room size",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 381.0, 332.0, 116.0 ],
					"varname" : "bp.Gigaverb",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 7.0, 100.0, 107.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 286.0, 623.0, 180.0, 54.0 ],
					"presentation_rect" : [ 604.0, 46.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Turn on the transport and set the BPM to control the sequencers",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 62.0, 469.0, 36.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 3.6875, 451.0, 60.0 ],
					"style" : "",
					"text" : "Gigaverb",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
,
					"patching_rect" : [ 173.0, 590.0, 111.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 8.0, 590.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 7.0, 228.0, 227.0, 116.0 ],
					"varname" : "HandClap",
					"viewvisibility" : 1
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 16.5, 362.0, 329.5, 362.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 329.5, 573.0, 146.5, 573.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-18::obj-29" : [ "mute[3]", "mute", 0 ],
			"obj-15::obj-23" : [ "bypass", "bypass", 0 ],
			"obj-18::obj-129" : [ "GateTime[2]", "GateTime", 0 ],
			...
			"obj-14::obj-37" : [ "Claps", "Claps", 0 ],
			"obj-14::obj-12" : [ "Mute[2]", "Mute", 0 ],
			"obj-15::obj-62" : [ "Dry", "Dry", 0 ],
			"obj-14::obj-28" : [ "Decay", "Decay", 0 ],
			"obj-14::obj-33" : [ "MaxFreq", "MaxFreq", 0 ],
			"obj-15::obj-63" : [ "Early", "Early", 0 ],
			"obj-14::obj-29" : [ "Q", "SampleStart", 0 ],
			"obj-18::obj-34" : [ "Pulse[2]", "Pulse", 0 ],
			"obj-14::obj-36" : [ "MinFreq", "MinFreq", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bp.Stereo.maxpat",
