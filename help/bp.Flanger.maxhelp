...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 232.0, 737.0, 157.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 232.0, 600.5, 150.0, 40.0 ],
									"text" : "Try changing the Rate"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 37.75, 553.0, 190.0, 116.0 ],
									"varname" : "bp.Flanger",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.0, 69.0, 575.0, 36.0 ],
									"text" : "An audio effect produced by mixing two identical signals together, one signal delayed by a small and gradually changing period, usually smaller than 20 milliseconds",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-6::obj-1" : [ "Width", "Width", 0 ],
			"obj-2::obj-6::obj-2" : [ "Rate", "Rate", 0 ],
			"obj-2::obj-6::obj-23" : [ "bypass", "bypass", 0 ],
			"obj-2::obj-6::obj-28" : [ "Center", "Center", 0 ],
			"obj-2::obj-6::obj-3" : [ "Regen", "Regen", 0 ],
			"obj-2::obj-7::obj-1" : [ "Sync[2]", "Sync", 0 ],
...
, 			{
				"name" : "bp.Flanger.maxpat",
				"bootpath" : "~/Documents/Max 8/Dev/BEAP/clippings/BEAP/Effects",
