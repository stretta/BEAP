...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-114",
					"items" : [ "send to...", ",", 1307, ",", 1312, ",", 1545, ",", 1547, ",", 1549, ",", 1551 ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"loopstart" : [ 0.0, "ms" ],
						"mode" : "basic",
						"originallength" : [ 499.470529571280224, "ticks" ],
						"originaltempo" : 27.009597355136076,
						"phase" : [ 0.0, "ticks" ],
						"pitchcorrection" : 0,
						"quality" : "basic",
						"timestretch" : [ 0 ]
...
, 			{
		...
		"parameters" : 		{
			"obj-129" : [ "SampleStart", "SampleStart", 0 ],
			"obj-151" : [ "LoopStart", "LoopStart", 0 ],
			"obj-152" : [ "LoopEnd", "LoopEnd", 0 ],
			"obj-19" : [ "import", "import", 0 ],
			"obj-20" : [ "power", "power", 0 ],
			"obj-32" : [ "getsamplelength", "getsamplelength", 0 ],
			"obj-49" : [ "RecordGate", "RecordGate", 0 ],
			"obj-57" : [ "Select all", "Select all", 0 ],
			"obj-61" : [ "Loop", "Loop", 0 ],
			"obj-63" : [ "Root", "Root", 0 ],
