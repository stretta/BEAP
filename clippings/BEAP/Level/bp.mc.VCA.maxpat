...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.25, 67.288360999999995, 343.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 432.0, 128.198700000000002, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 432.0, 165.956634521484375, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 514.5, 128.198699951171875, 80.0, 20.0 ],
					"text" : "mc.clip~ 0. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 389.5, 321.956635000000006, 46.0, 21.0 ],
					"text" : "sig~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 389.5, 356.956634521484375, 61.0, 21.0 ],
					"text" : "mc.pow~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 322.0, 356.956635000000006, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 322.0, 401.95660400390625, 97.0, 20.0 ],
					"text" : "mc.selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.0, 146.0, 255.0, 0.555358500803032 ],
					"id" : "obj-25",
					"ignoreclick" : 1,
					"maxclass" : "textbutton",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.0, 667.516602000000034, 123.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 263.0, 625.5166015625, 100.0, 20.0 ],
					"text" : "mc.snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 263.0, 586.5166015625, 54.0, 20.0 ],
					"text" : "mc.abs~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 263.0, 536.5166015625, 60.0, 20.0 ],
					"text" : "mc.*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 527.0, 351.124908000000005, 123.0, 20.0 ],
					"text" : "bgcolor 0 146 255 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 527.0, 309.124908447265625, 100.0, 20.0 ],
					"text" : "mc.snapshot~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 527.0, 270.124908447265625, 54.0, 20.0 ],
					"text" : "mc.abs~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 29.25, 103.771973000000003, 59.5, 20.0 ],
					"restore" : 					{
						"Bypass" : [ 0.0 ],
						"Quadrants" : [ 0.0 ],
						"Response" : [ 0.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 81.25, 481.104614000000026, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 81.25, 526.1046142578125, 97.0, 20.0 ],
					"text" : "mc.selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 597.0, 76.456634521484375, 60.0, 20.0 ],
					"text" : "mc.*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 136.25, 481.1046142578125, 40.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.25, 41.712066650390625, 41.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 441.5, 293.456635000000006, 409.5, 293.456635000000006 ],
					"order" : 2,
					"source" : [ "obj-24", 0 ]
				}
