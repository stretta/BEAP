...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 48.0, 82.0, 342.0, 20.0 ],
									"style" : "",
									"text" : "## Simple CV-controllable LFO without the graphic display. ## "
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 585.936401, 197.0, 36.0, 15.0 ],
									"presentation" : 1,
