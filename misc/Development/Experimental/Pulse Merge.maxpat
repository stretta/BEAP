...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 43.0, 227.0, 119.0, 18.0 ],
													"text" : "Scale to incoming amp"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 309.5, 191.0, 33.0, 18.0 ],
													"text" : "> 2.5"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 225.0, 264.0, 174.0, 18.0 ],
													"text" : "Allows longer pulses to carry over"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 162.0, 266.0, 57.0, 18.0 ],
													"text" : "maximum"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 225.0, 90.0, 169.0, 18.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 162.0, 227.0, 32.5, 18.0 ],
													"text" : "*"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 162.0, 128.0, 32.5, 18.0 ],
													"text" : "<"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 162.0, 57.0, 19.0, 18.0 ],
													"text" : "1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 162.0, 90.0, 44.0, 18.0 ],
													"text" : "+="
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 295.0, 230.0, 34.0, 18.0 ],
													"text" : "latch"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 187.0, 57.0, 155.0, 18.0 ],
													"text" : "in 1 @comment \"Rising Edge\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 295.0, 153.0, 247.0, 18.0 ],
													"text" : "in 2 @comment \"Incoming gate signal.  Can vary\""
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 162.0, 308.0, 34.0, 18.0 ],
													"text" : "out 1"
												}
...
,
									"patching_rect" : [ 607.5, 475.754272, 88.0, 20.0 ],
									"text" : "gen~"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 70.0, 128.0, 46.0, 20.0 ],
													"text" : ">~ 2.5"
												}
...
,
									"patching_rect" : [ 607.5, 367.0, 54.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 676.5, 399.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 676.5, 367.0, 181.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 56.0, 0.0, 41.0, 17.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 626.5, 207.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 676.5, 161.0, 105.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 116.0, 155.0, 146.0, 47.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 50.0, 182.0, 64.0, 20.0 ],
													"text" : "tapout~ 0"
												}
...
,
									"patching_rect" : [ 891.5, 280.0, 51.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial Bold",
										"default_fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 514.431091, 234.5, 40.0, 20.0 ],
									"text" : "Input"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 740.5, 222.5, 117.0, 20.0 ],
									"text" : "Delay time (signal)"
								}

							}
, 							{
								"box" : 								{
									"comment" : "delay time (1V/10^)",
									"id" : "obj-27",
									"maxclass" : "inlet",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 923.5, 222.5, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1.768768, 1.211548, 41.0, 17.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 304.431091, 411.0, 49.0, 20.0 ],
									"text" : "bypass"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 304.431091, 499.754272, 32.5, 20.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 304.431091, 554.754272, 204.0, 20.0 ],
									"text" : "selector~ 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 304.431091, 454.691772, 40.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 76.518768, 19.0, 52.0, 14.764645 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 304.431091, 600.754272, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 676.5, 96.0, 44.0, 47.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 126.0, 323.754272, 59.5, 20.0 ],
									"restore" : 									{
										"Time" : [ 0.1 ],
										"bypass" : [ 0.0 ]
									}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 81.642456, 465.0, 48.0, 27.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ -1.0, -1.0, 134.0, 116.0 ],
					"varname" : "SignalDelay"
				}
