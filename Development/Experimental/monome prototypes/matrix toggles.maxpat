...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 186.0, 216.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 217.5, 120.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.0, 217.5, 48.0, 20.0 ],
					"text" : "route 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.0, 186.0, 51.0, 20.0 ],
					"text" : "zl rot -2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.5, 558.5, 94.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.5, 462.0, 74.5, 20.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 126.0, 343.0, 93.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.5, 418.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 418.0, 32.5, 18.0 ],
					"text" : "255"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 200.0, 380.0, 100.0, 20.0 ],
					"text" : "sel 0 255"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 51.0, 299.5, 94.0, 21.0 ],
					"text" : "jit.matrix plane"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 260.5, 79.0, 18.0 ],
					"text" : "getcell $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.0, 149.5, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.5, 507.5, 113.0, 18.0 ],
...
,
					"patching_rect" : [ 51.0, 15.0, 223.0, 116.0 ],
					"varname" : "serialosc[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 629.0, 100.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 15.0, 559.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 15.0, 584.0, 94.0, 21.0 ],
					"text" : "jit.matrix plane"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 172.5, 412.0, 181.75, 412.0 ],
					"source" : [ "obj-49", 2 ]
				}
