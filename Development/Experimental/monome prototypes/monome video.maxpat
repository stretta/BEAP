...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 363.5, 443.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 59.0, 631.0, 160.0, 120.0 ],
					"presentation_rect" : [ 56.5, 631.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 253.5, 523.0, 129.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 893.25, 1001.0, 160.0, 120.0 ],
					"presentation_rect" : [ 893.25, 1001.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 704.5, 1001.0, 160.0, 120.0 ],
					"presentation_rect" : [ 704.5, 1001.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 516.25, 994.0, 160.0, 120.0 ],
					"presentation_rect" : [ 514.5, 993.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 327.5, 994.0, 160.0, 120.0 ],
					"presentation_rect" : [ 325.0, 994.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 314.0, 745.0, 160.0, 120.0 ],
					"presentation_rect" : [ 314.0, 750.0, 160.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 153.0, 133.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 121.0, 192.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 24.0, 87.0, 230.0, 125.0 ]
				}
...
,
					"patching_rect" : [ 571.5, 745.0, 166.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 817.919983, 298.0, 32.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 935.919983, 197.5, 53.0, 21.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 876.919983, 197.5, 53.0, 21.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 817.919983, 257.0, 137.0, 21.0 ],
					"text" : "pak offset 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 571.5, 655.880005, 207.0, 20.0 ],
...
,
					"patching_rect" : [ 825.0, 819.0, 223.0, 116.0 ],
					"varname" : "serialosc[2]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 571.5, 690.089966, 187.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.5, 487.25, 101.0, 24.0 ],
					"text" : "refresh matrix"
				}
...
,
					"patching_rect" : [ 571.5, 819.0, 223.0, 116.0 ],
					"varname" : "serialosc[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 571.5, 474.5, 49.5, 49.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 571.5, 588.0, 185.0, 21.0 ],
					"text" : "jit.matrix plane 4 char 320 240"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 33.5, 234.5, 263.0, 234.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 581.0, 555.5, 581.0, 555.5 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 827.419983, 465.929993, 581.0, 465.929993 ],
					"source" : [ "obj-88", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 840.919983, 641.320007, 581.0, 641.320007 ],
					"source" : [ "obj-88", 1 ]
				}
