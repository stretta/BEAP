...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 305.0, 576.0, 133.0, 54.0 ],
									"style" : "",
									"text" : "Play with the mix to hear the comb filter effect"
								}
...
,
									"patching_rect" : [ 739.0, 540.0, 111.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 332.0, 443.5, 133.0, 25.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 559.0, 56.0, 346.0, 40.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 787.0, 235.0, 137.0, 116.0 ],
									"varname" : "bp.LFO",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 38.6875, 710.0, 148.0, 116.0 ],
									"varname" : "bp.Stereo",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 597.0, 401.5, 244.0, 116.0 ],
									"varname" : "bp.DFLFO",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 44.0, 115.0, 726.0, 232.0 ],
...
,
									"patching_rect" : [ 38.6875, 534.5, 245.0, 116.0 ],
									"varname" : "CombFilter",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 44.0, 390.5, 280.0, 116.0 ],
									"varname" : "bp.Cloud",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.375, 524.875, 259.625, 135.25 ],
									"proportion" : 0.39,
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "Implements a classic comb filter effect",
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 914.5, 370.25, 227.5, 370.25 ],
									"source" : [ "obj-1", 4 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 796.5, 370.25, 314.5, 370.25 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 48.1875, 679.5, 177.1875, 679.5 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 48.1875, 679.5, 48.1875, 679.5 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 760.5, 393.0, 606.5, 393.0 ],
									"source" : [ "obj-2", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 53.5, 368.25, 53.5, 368.25 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 606.5, 527.25, 198.854167, 527.25 ],
									"source" : [ "obj-22", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 53.5, 532.0, 48.1875, 532.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-10::obj-7" : [ "Bypass", "Bypass", 0 ],
...
, 			{
		...
		"snapshot" : 		{
			...
			"version" : 1,
			"name" : "bp.Comb Filter.maxhelp",
			"origin" : "bp.Comb Filter.maxhelp",
			"type" : "patcher",
			"subtype" : "Undefined",
			"snapshot" : 			{
				"name" : "bp.Comb Filter.maxhelp",
