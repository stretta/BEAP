...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.25, 409.0, 230.0, 20.0 ],
					"style" : "",
					"text" : "Try changing the Attack and Decay."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.25, 343.0, 230.0, 60.0 ],
					"style" : "",
					"text" : "AD requires a Gate signal for the Attack/Decay cycles to commence, each time it receives this signal it completes the cycle."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 58.0, 18.0, 726.0, 232.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 563.0, 341.25, 33.0 ],
					"style" : "",
					"text" : "Decay time is the time taken for the subsequent run down from the attack level to the designated sustain level."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 517.0, 341.25, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.25, 315.0, 114.0, 20.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 212.0, 554.0, 111.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 58.0, 554.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 58.0, 409.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 58.0, 271.0, 280.0, 116.0 ],
					"varname" : "bp.Cloud",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 437.0, 315.0, 100.0, 116.0 ],
					"varname" : "bp.AD",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.5, 291.5, 357.5, 163.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"grad2" : [ 0.65098, 0.666667, 0.662745, 0.39 ],
					"id" : "obj-15",
					"maxclass" : "panel",
					"mode" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.5, 504.0, 357.5, 110.5 ],
					"proportion" : 0.39,
					"style" : ""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 446.5, 461.0, 183.0, 461.0, 183.0, 405.0, 161.5, 405.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 774.5, 273.0, 446.5, 273.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 67.5, 540.0, 196.5, 540.0 ],
					"source" : [ "obj-4", 0 ]
				}
