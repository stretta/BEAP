...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.5, 178.0, 99.0, 66.0 ],
					"presentation_rect" : [ 56.0, 164.0, 0.0, 0.0 ],
					"text" : "Use four quadrant for ring modulation."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 167.0, 150.0, 64.0 ],
					"text" : "To convert the modulator to unipolar, set gain at 50% and bias to 2.5v"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 687.0, 24.5, 53.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 758.0, 115.0, 53.0, 17.0 ],
					"text" : "PRESETS",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 687.0, 51.75, 113.0, 63.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.0, 6.0, 130.011475, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 758.0, 98.0, 370.011475, 17.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.0, 42.5, 130.011475, 79.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 758.0, 135.0, 370.011475, 96.114227 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.0, 15.75, 130.011475, 106.25 ],
					"presentation" : 1,
					"presentation_rect" : [ 758.0, 115.0, 370.011475, 116.114227 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 709.0, 59.75, 64.0, 13.0 ],
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 709.0, 78.25, 84.0, 24.0 ],
										...
										"slots" : 										{
											"1" : 											{
												...
												"data" : 												{
													...
													"StereoOutput::Level" : [ -24.486759 ],
													"StereoOutput::Mute" : [ 1.0 ],
													"StereoOutput::OutputChannel" : [ 0.0 ],
													"GainAndBias::Bias" : [ 0.0 ],
													"GainAndBias::Gain" : [ 100.0 ],
													"GainAndBias::Mute" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 709.0, 102.25, 84.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 687.0, 87.25, 91.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 701.0, 59.75, 85.0, 17.0 ],
...
,
					"patching_rect" : [ 455.0, 128.0, 101.0, 116.0 ],
					"varname" : "Scope"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 511.0, 385.470001, 59.5, 20.0 ],
									"restore" : 									{
										"Bias" : [ 0.0 ],
										"Gain" : [ 100.0 ],
										"Mute" : [ 0.0 ]
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 223.131287, 404.0, 32.5, 20.0 ],
									"text" : "!= 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 223.131287, 459.0, 117.431091, 20.0 ],
									"text" : "gate~ 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 223.131287, 513.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 223.131287, 328.0, 40.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 43.0, 19.0, 42.0, 14.764645 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_enum" : [ "val1", "val2" ],
											"parameter_mmax" : 1.0,
...
,
					"patching_rect" : [ 352.0, 128.0, 90.0, 116.0 ],
					"varname" : "GainAndBias"
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 441,
					"outlettype" : [ "" ],
					"patching_rect" : [ 601.0, 320.0, 345.0, 206.0 ],
					"subplots" : [ 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 320.0, 386.0, 206.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 196.0, 278.0, 42.0, 20.0 ],
					"text" : "*~ 0.2"
				}
...
,
					"patching_rect" : [ 20.0, 410.0, 148.0, 116.0 ],
...
, 							{
								"box" : 								{
									"bgcolor" : [ 0.0, 146.0, 255.0, 0.965345 ],
...
, 							{
								"box" : 								{
									"bgcolor" : [ 0.0, 146.0, 255.0, 0.861906 ],
									"bgovercolor" : [ 0.698039, 0.698039, 0.698039, 0.0 ],
									"border" : 1,
									"bordercolor" : [ 0.101961, 0.101961, 0.101961, 0.54 ],
									"borderoncolor" : [ 0.101961, 0.101961, 0.101961, 0.54 ],
...
,
					"patching_rect" : [ 20.0, 251.0, 103.0, 116.0 ],
					"varname" : "VCA"
				}
...
,
					"patching_rect" : [ 352.0, 6.0, 311.0, 116.0 ],
...
,
					"patching_rect" : [ 20.0, 6.0, 311.0, 116.0 ],
					"varname" : "Oscillator"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 205.5, 308.5, 610.5, 308.5 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 29.5, 388.0, 158.5, 388.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 29.5, 376.0, 160.5, 376.0, 160.5, 269.0, 205.5, 269.0 ],
					"source" : [ "obj-42", 0 ]
				}
