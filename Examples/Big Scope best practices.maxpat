...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 166.5, 260.0, 127.0 ],
					"text" : "The best practice to working with Big Scope is to use the Smart or 1v/oct mode to calculate the number of sample points for you, then switch back to manual to lock that rate. Smart mode calculates frequency based on the input signal. 1v/oct mode requires a signal at the 1v/oct input and assumes the oscillator is not offset. Both modes track continuously at relatively slow 1Hz rate. "
				}
...
,
					"patching_rect" : [ 90.0, 172.0, 211.0, 116.0 ],
					"varname" : "FM"
				}
...
,
					"patching_rect" : [ 90.0, 605.0, 148.0, 116.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 303.0, 180.0, 26.623941, 16.734447 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
								...
								"box" : 								{
									...
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											...
											"parameter_enum" : [ "Manual", "Smart", "1v/oct" ],
...
,
					"patching_rect" : [ 90.0, 324.0, 372.0, 233.0 ],
					"varname" : "BigScope"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 99.5, 162.0, 452.5, 162.0 ],
					"source" : [ "obj-1", 0 ]
				}
