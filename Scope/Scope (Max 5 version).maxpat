...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"fgcolor" : [ 0.0, 0.717231, 1.0, 1.0 ],
									"gridcolor" : [ 0.329412, 0.329412, 0.329412, 0.38 ],
									"id" : "obj-3",
									"maxclass" : "scope~",
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 567.0, 292.0, 130.0, 130.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 43.0, 78.0, 52.0 ],
									"range" : [ -5.0, 5.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.0, 19.0, 69.0, 17.0 ],
									"text" : "SCOPE (M5)",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
